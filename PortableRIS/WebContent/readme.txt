...
【適用方法】
1. C:\Program Files\Apache Software Foundation\Tomcat 8.5\webapps をバックアップします。
...
6. C:\Program Files\Apache Software Foundation\Tomcat 8.5\webapps配下に、
   PortableRIS（手順2,3,4で設定したもの）を配置します。
 
7. Tomcat サービス開始します。   ★この時点から Tomcat関連アプリケーション が開始します。

8. C:\Program Files\Apache Software Foundation\Tomcat 8.5\logs 以下に
   PortableRIS.log
   が作成されることを確認して下さい。
