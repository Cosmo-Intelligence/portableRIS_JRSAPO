			...
			for (int lp = 0; lp < kensaKikiList.size(); lp++)
			{
				...
				while (e3.hasMoreElements()){
					...
					*/
					...
					// 2022.09.09 Add K.Yasuda@COSMO Start
					Integer ex_startNumberInt = (Integer.parseInt(ex_startNumber)) +1;
					ex_startNumber = ex_startNumberInt.toString();
					// 2022.09.09 Add K.Yasuda@COSMO End
