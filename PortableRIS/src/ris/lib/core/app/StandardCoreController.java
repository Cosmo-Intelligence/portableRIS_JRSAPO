			...
			if (risID != null && risID.length() > 0 && status != null && user != null)
			{
				...
				else
				{
					...
					if (checkoutRow != null)
					{
						...
						OrderInfoBean orderBean = GetRisOrderInfo(risID, 0, con);
//						OrderInfoBean orderBean = GetRisOrderInfo(risID, con);
	...
	*/
	...
	@Override
	// 2023.07.26 Mod Nishihara@COSMO Start 撮影済ボタン機能追加
	public ExecutionInfoBean GetRisExecutionInfo(String risID, int satueiFinishFlg, Connection con)
//	public ExecutionInfoBean GetRisExecutionInfo(String risID, Connection con)
	// 2023.07.26 Mod Nishihara@COSMO End 撮影済ボタン機能追加
	{
		...
		try
		{
			...
			{
				// 2023.07.26 Mod Nishihara@COSMO Start 撮影済ボタン機能追加
				executionInfoBean = resultHandler.GetExecutionInfoBean(risID, satueiFinishFlg, con);
//				executionInfoBean = resultHandler.GetExecutionInfoBean(risID, con);
	...
	*/
	...
	@Override
	// 2023.07.26 Mod Nishihara@COSMO Start 撮影済ボタン機能追加
	public OrderInfoBean GetRisOrderInfo(String risID, int satueiFinishFlg, Connection con) throws Exception
//	public OrderInfoBean GetRisOrderInfo(String risID, Connection con) throws Exception
	// 2023.07.26 Mod Nishihara@COSMO End 撮影済ボタン機能追加
	{
		...
		try
		{
			...
			{
				// 2023.07.26 Mod Nishihara@COSMO Start 撮影済ボタン機能追加
				orderInfoBean = orderHandler.GetRisOrderData(risID, satueiFinishFlg, con);
//				orderInfoBean = orderHandler.GetRisOrderData(risID, con);
	...
	*/
	...
	/// <returns></returns>
	@Override
	public boolean RegistSatueiRisExecutionInfo(ExecutionInfoBean bean, Connection con)
	{
		// 進捗：完了
		...
		try
		{
			if (bean != null)
			{
				retBool = resultHandler.RegistSatueiRisExecutionInfo(bean, con);
			}
		}
		catch (Exception e)
		{
	...
	@Override
	// 2023.07.26 Mod Nishihara@COSMO Start 撮影済ボタン機能追加
	public ArrayList GetRisPresetInfoData(PresetParameter param, int satueiFinishFlg, Connection con)
//	public ArrayList GetRisPresetInfoData(PresetParameter param, Connection con)
	// 2023.07.26 Mod Nishihara@COSMO End 撮影済ボタン機能追加
	{
		...
		{
			// 2023.07.26 Mod Nishihara@COSMO Start 撮影済ボタン機能追加
			retList = masterHandler.GetPresetInfoData(param, satueiFinishFlg, con);
//			retList = masterHandler.GetPresetInfoData(param, con);
	...
	*/
	...
	// 2023.07.26 Mod Nishihara@COSMO Start 撮影済ボタン機能追加
	public boolean unCheckOutExclusive(BaseDto dto, String checkoutID,Connection con,boolean exclusive){
