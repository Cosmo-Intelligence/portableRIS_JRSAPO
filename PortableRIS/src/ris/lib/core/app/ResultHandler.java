...
public class ResultHandler
{
	...
	public ExecutionInfoBean GetExecutionInfoBean(String risID, int satueiFinishFlg, Connection con) throws Exception
...
//					}
	...
	*/
	...
	/// <param name="bean">実績情報</param>
	/// <returns></returns>
	public boolean RegistSatueiRisExecutionInfo(ExecutionInfoBean bean, Connection con) throws Exception
	{
		// parameters
		boolean retBool = false;
		RisExMainTbl			exMainTbl			= new RisExMainTbl();
