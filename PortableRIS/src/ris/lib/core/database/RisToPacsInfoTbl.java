...
///
/// </summary>
public class RisToPacsInfoTbl extends BaseTbl
{
	// アクセステーブル名
	public static final  String TABLE_NAME					= "TOPACSINFO";
	...
	public DataTable GetRisToPacsInfo(Connection con, Transaction trans, String risID, String requestID)
	{
		// parameters
		DataTable dt = null;
	...
	*/
	...
	/// <param name="bean">送信データ</param>
	/// <returns></returns>
	public boolean InsertToPacsData( Connection con, ToHisInfoBean bean , String userName) throws Exception
	{
		// parameters
