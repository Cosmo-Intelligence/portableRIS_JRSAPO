...
///
/// </summary>
public class RisPresetZoueizaiMasterTbl extends BaseTbl
{
	// アクセステーブル名
	public static final String TABLE_NAME = "PRESETZOUEIZAIMASTER";
	private static final String TABLE_CAPTION = "プリセット器材マスタ";
	private static String TableNameStr	= Configuration.GetInstance().GetRisDbUserStr() + "." + TABLE_NAME;

	// カラム定義
	public static final String PRESET_ID_COLUMN				= "PRESET_ID";				//Ris.PresetZoueizaiMaster.PRESET_ID
	public static final String NO_COLUMN						= "NO";						//Ris.PresetZoueizaiMaster.NO
	public static final String ZOUEIZAI_ID_COLUMN				= "ZOUEIZAI_ID";			//Ris.PresetZoueizaiMaster.ZOUEIZAI_ID
	public static final String ZOUEIZAIKBN_COLUMN				= "ZOUEIZAIKBN";			//Ris.PresetZoueizaiMaster.ZOUEIZAIKBN
	public static final String SUURYOU_IJI_COLUMN				= "SUURYOU_IJI";			//Ris.PresetZoueizaiMaster.SUURYOU_IJI
	public static final String SUURYOU_COLUMN					= "SUURYOU";				//Ris.PresetZoueizaiMaster.SUURYOU
	public static final String PARTSBUNRUI_ID_COLUMN			= "PARTSBUNRUI_ID";			//Ris.PresetZoueizaiMaster.PARTSBUNRUI_ID
	public static final String DETAILPARTSBUNRUI_ID_COLUMN		= "DETAILPARTSBUNRUI_ID";	//Ris.PresetZoueizaiMaster.DETAILPARTSBUNRUI_ID

	/// <summary>
	/// コンストラクタ
	/// </summary>
	public RisPresetZoueizaiMasterTbl()
	{
	...
	/// <returns>プリセット器材情報</returns>
	public ArrayList GetPresetZoueizaiData(Connection con, PresetParameter param) throws Exception
	{
		// parameters
